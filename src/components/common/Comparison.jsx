  ...
  return (
    <section className="w-full bg-brand-primary/5 py-[40px] md:py-[60px] overflow-hidden">
      <div className="w-full px-[4%] md:px-[6%] mx-auto  flex flex-col items-center lg:items-start">
        ...
        {/* Header Block */}
        <div className="flex flex-col mb-10 md:mb-16 pl-4 border-l-[8px] border-brand-primary self-start w-full">
          <h2 className="text-3xl lg:text-5xl font-black leading-tight tracking-tight text-brand-dark">
            What Makes Us <span className="text-brand-primary">Better?</span>
          </h2>
          <p className="text-lg md:text-xl font-bold opacity-90 text-brand-dark mt-2">
